...
export default function EditArticlePage() {
  ...
  useEffect(() => {
    adminApi.getArticles()
      .then(r => {
        const article = r.articles.find((a: Article) => a.id === id)
        if (article) setForm({ title: article.title, slug: article.slug, body: article.body, status: article.status as 'draft' | 'published' })
      })
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await adminApi.updateArticle(id, form)
